...
class Connection extends \mysqli {
     ...
     * @return Data A more easily searchable response-data type generated by the query.
     */
    public function query($query, $strings = [], $pattern = "/%([0-9]+)/"): Data {
        ...
        $data = new Data($rv, $this->errno, $this->error);
        if (!is_bool($rv)){
            $rv->free_result();
        }
